#!/bin/bash
# Complete Cybersecurity Data Integration Script
# Run this after placing your raw data files

set -e  # Exit on error

echo "🚀 BookGen AI - Cybersecurity Data Integration"
echo "=============================================="
echo ""

# Step 1: Create directory structure
echo "📁 Step 1: Creating directory structure..."
mkdir -p llm-service/data/raw_sources/cybersecurity
mkdir -p llm-service/data/training_sets/cybersecurity

echo "✅ Directories created"
echo ""

# Step 2: Instructions for file placement
echo "📋 Step 2: File Placement Instructions"
echo "-------------------------------------"
echo "Place your downloaded files in: llm-service/data/raw_sources/cybersecurity/"
echo ""
echo "Rename them as follows:"
echo ""
echo "1. NVD/CVE JSON data → nvd_cve_2025.json"
echo "2. MITRE ATT&CK JSON → mitre_attack_enterprise.json"  
echo "3. Ubuntu Security XML → ubuntu_security_notices.xml"
echo "4. ArXiv Papers XML → arxiv_crypto_papers.xml"
echo "5. Microsoft Updates JSON → microsoft_security_updates.json"
echo ""
read -p "Press Enter when files are in place..."
echo ""

# Step 3: Create the processor script
echo "📝 Step 3: Creating data processor script..."
cat > llm-service/process_cyber_data.py << 'PROCESSOR_EOF'
#!/usr/bin/env python3
...
chmod +x llm-service/process_cyber_data.py
echo "✅ Processor script created"
echo ""

# Step 4: Run the processor
echo "🔄 Step 4: Processing raw data files..."
cd llm-service
python3 process_cyber_data.py
echo ""

# Step 5: Validate processed data
echo "✅ Step 5: Validating processed data..."
python3 validate_data.py --domain cybersecurity
echo ""

# Step 6: Import to MongoDB
echo "📥 Step 6: Importing to MongoDB..."
python3 demo_manual_import.py import-dir \
...
echo "📊 Step 7: Checking import statistics..."
python3 demo_manual_import.py stats --domain-id cybersecurity
echo ""
...
echo ""
echo "Next steps:"
echo "1. Review the imported data statistics above"
echo "2. Train your cybersecurity model:"
echo "   python3 demo_manual_import.py train --domain-id cybersecurity"
echo "3. Test text generation with trained model"
echo ""
echo "Your cybersecurity training data is ready! 🚀"
